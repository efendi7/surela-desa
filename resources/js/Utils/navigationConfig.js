...
// Impor ikon jika Anda menggunakan library ikon seperti lucide-vue-next
// import { Home, FileText, Book, Eye, Users, Building, FileStack, Inbox, History, UsersRound } from 'lucide-vue-next';
    ...
    if (user?.role === 'admin') {
        sections.push({
            ...
            items: [
                ...
                // =======================================================
                // == PERUBAHAN DI SINI: MENAMBAHKAN MENU PERANGKAT DESA ==
                // =======================================================
                {
                    name: 'Perangkat Desa',
