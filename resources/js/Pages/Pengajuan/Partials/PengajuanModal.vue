                    ...
                    <div v-if="pengajuan.status === 'selesai' && pengajuan.file_hasil" class="bg-white rounded-lg p-6 shadow-sm">
                        ...
                        <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                                ...
                                <a :href="route('pengajuan.download', { pengajuan: pengajuan.id })" class="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg shadow-sm transition-colors">
