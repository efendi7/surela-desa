                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="flex flex-col sm:flex-row items-center mb-6">
                            <img v-if="profilDesa.logo" :src="'/storage/' + profilDesa.logo" alt="Logo Desa" class="w-24 h-24 rounded-full object-cover mb-4 sm:mb-0 sm:mr-6 border">
                            <img v-else src="https://placehold.co/100x100/e2e8f0/e2e8f0?text=Logo" alt="Logo Desa" class="w-24 h-24 rounded-full object-cover mb-4 sm:mb-0 sm:mr-6 border">
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-500 mt-1">
                                    <span v-if="profilDesa.nama_kecamatan">Kec. {{ profilDesa.nama_kecamatan }}</span>
                                    <span v-if="profilDesa.nama_kecamatan && profilDesa.nama_kabupaten"> | </span>
                                    <span v-if="profilDesa.nama_kabupaten">Kab. {{ profilDesa.nama_kabupaten }}</span>
                                    <span v-if="profilDesa.nama_kabupaten && profilDesa.nama_provinsi"> | </span>
                                    <span v-if="profilDesa.nama_provinsi">{{ profilDesa.nama_provinsi }}</span>
                                </div>
                            </div>
                        </div>

                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                            <div><strong class="block text-gray-500">Email</strong> {{ profilDesa.email }}</div>
                            <div><strong class="block text-gray-500">Telepon</strong> {{ profilDesa.telepon }}</div>
  ...
  {{ profilDesa.telepon || '-' }}
                        ...
                        <div class="border-b pb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <TextInput id="nama_desa" v-model="form.nama_desa" type="text" class="mt-1 block w-full" />
    ...
    <InputError :message="form.errors.kode_pos" class="mt-2" />
                            ...
                            <div class="mt-4">
                                ...
                                <TextInput id="alamat" v-model="form.alamat" type="text" class="mt-1 block w-full" />
                ...
                <div class="flex items-center justify-end p-6 bg-gray-50 border-t">
                    ...
                    <PrimaryButton @click="submitUpdate" class="ms-3" :disabled="form.processing">Simpan Perubahan</PrimaryButton>
                </div>
            </div>
        </Modal>
    </AuthenticatedLayout>
