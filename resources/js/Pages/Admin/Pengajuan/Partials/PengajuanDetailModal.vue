            ...
            <div class="flex-1 overflow-y-auto p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div class="space-y-6">
                       ...
                       <!-- Bagian Lampiran di Modal Admin - Ganti dengan kode ini -->
<section class="p-4 bg-white rounded-lg shadow-sm">
        ...
        Tidak ada lampiran.
                    ...
                    <form @submit.prevent="submit" class="h-full flex flex-col space-y-6 p-4 bg-white rounded-lg shadow-sm">
                        ...
                        <div>
                            ...
                            <input v-model="form.nomor_surat" id="nomor_surat" type="text"
                        ...
                        <div class="flex-1">
                            ...
                            <textarea v-model="form.keterangan_admin" id="keterangan_admin" rows="4"
                                class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 
                                       rounded-md shadow-sm"
                                placeholder="Berikan catatan jika pengajuan ditolak..."></textarea>
                        </div>
                    </form>
                </div>
            </div>
